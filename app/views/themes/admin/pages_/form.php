	 ...
	 <div class="tab-content">
        <div class="tab-pane active" id="item">
			...
			<fieldset>
				...
				<?php echo form_dropdown('page[form]', array(NULL => 'Nessun form', 'generic' => 'Form Generico', 'book' => 'Form Prenotazione'), set_value('page[form]', $page->form), 'class="span3" id="page[form]"') ?>
