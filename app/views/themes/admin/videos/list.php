<a href="<?php echo uri_string() ?>/inserisci" class="btn pull-right">Aggiungi Video <i class="icon-plus-sign"></i></a>
<?php echo form_open('', 'class="form-search pull-right" style="margin-right:20px"') ?>
    <div class="input-append">
        <?php echo form_input('', set_value(), 'placeholder="Cerca Video" class="input-large search-query"') ?>
	...
	<table class="table table-striped table-hover">
		...
		<tbody class="sortable-list">
			...
			<tr>
				...
				<td width="10%"><?php echo $this->layout->load_view('layouts/snippets/is_published', array('item' => $item), TRUE) ?></td>
			...
			<tr>
				<td colspan="4">
					Nessun Video trovato. <a href="<?php echo uri_string() ?>/inserisci">Inserisci un Video.</a>
				</td>
			</tr>
			<?php endif ?>
		</tbody>
