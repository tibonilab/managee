 ...
 * @author Alberto
 */
class Professional extends Route{
	public $id;
    public $name;
    ...
    private function _init_contents()
    {
		...
		{
			$content = new Professional_content();
	...
	private function _set_images()
	{
		...
		{
			$this->_images = $this->front_professional_model->get_images($this->id);
		}
		else
		{
			$this->_images = $this->professional_model->get_images($this->id);
		}
	}
	...
	{
		$this->_content = $this->front_professional_model->get_content($this->id);
		$this->set_route();
	}
	...
	{
		$template = '/professionals/forms/' . $this->form;
